  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="rounded-lg shadow-md p-6 mb-6 text-center items-center" style={{ background: themeStyles.primaryColor, padding: '20px' }}>
        <div className="bg-white p-6 rounded-lg shadow-md"> {/* White div */}
      ...
      <div className="rounded-lg shadow-md p-6 mb-6" style={{ background: themeStyles.primaryColor, padding: '20px', width: '100%' }}>
        <div className="bg-white p-6 rounded-lg shadow-md"> {/* White div */}
          <div className="flex justify-center">
          ...
          <ol className="list-decimal text-left pl-10">
            {faqs.map((faq, index) => (
      ...
      {/* Need more information? Watch Me! */}
