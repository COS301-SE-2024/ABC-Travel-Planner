...
const SplashPage = () => {
    ...
    return (
        <div style={{...styles.container, flexDirection: 'column', overflowY: 'auto'}}>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-6">
                          <form style={styles.form} onSubmit={handleLogin}>
                            <h1 style={{...styles.headers, textAlign: 'center'}}>Login </h1>
                            <div className="mb-3">
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-6">
                            ...
                            <h1 style={{...styles.headers, textAlign: 'center'}}>Register</h1>
                                <div className="mb-3">
