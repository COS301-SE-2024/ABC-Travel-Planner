...
const Home = () => {
  ...
  const { selectedTheme, themeStyles, setTheme } = useTheme(); // Ensure this returns both theme and a setter
  ...
  }, [themeStyles]); // Re-run this effect when the theme styles change
