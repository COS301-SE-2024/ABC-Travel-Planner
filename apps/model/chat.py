...
def is_query_related(query):
    ...
    social_media_keywords = ['post', 'like', 'comment', 'share', 'follow', 'login', 'logout', 'user', 'account', 'update', 'block', 'mute', 'profile', 'message', 'dm', 'friend', 'timeline', 'feed', 'story', 'share', 'dark mode', 'light mode', 'edit', 'image', 'password']
    ...
    farewell_keywords = ['goodbye', 'bye', 'see you', 'farewell', 'take care', 'later', 'catch you later', 'talk to you later', 'peace', 'adios', 'ciao', 'good night', 'so long', 'see you later', 'have a good day', 'good night', 'see ya', 'thank you', 'thanks', 'welcome', 'talk']
